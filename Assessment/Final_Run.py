...
#TODO: redo connections after newly generated lse files
#TODO: include new structure comparison
...
newclass.run(start_from_results=False, save_result_data=True, path_to_save='Results/Results_Second_Rule.json',
             save_structure_analysis=True, restart_from_saved_structure_analysis=False, show_histogram=True, stepsize_histogram=0.1)
#
...
#
# print("Analysis of the third rule: only structures with ALL CN smaller or equal to 8 will be considered! This is different from the last analysis!")
...
#              path_to_save='Results/Results_Third_Rule_max_CN_for_whole_structure.json', threshold_remove_elements=0.90, start_material=None,
...
# #TODO: also include this in experimental assessment
#
#
