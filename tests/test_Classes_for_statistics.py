...
class TestPauling2OverAllAnalysis(unittest.TestCase):
    ...
    def test_get_cases_with_extreme_deviations(self):
        #TODO: correct this!
        addi={"mp-3400": [0,4,2,2], "mp-4000":[2,2,2,2], "mp-3000":[2.2,2,2], "mp-3001":[2.21,2,2], "mp-700":[1.8,2,2], "mp-600":[1.79,2,2]}
        exceptions=self.pauling2_normal._get_extreme_exceptions(additional_info=addi,perc_std=0.1,ideal_value=2,larger_how_many_std=1)
