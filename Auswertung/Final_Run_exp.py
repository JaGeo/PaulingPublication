from Classes_for_statistics import Pauling1OverAllAnalysis, Pauling2OverAllAnalysis, Pauling3OverAllAnalysis, \
    Pauling4OverAllAnalysis, Pauling5OverAllAnalysis, Pauling1Entropy, Pauling1Frequency, AllPaulingOverAllAnalysis, AllPaulingOverAllAnalysis_Final_Summary
...
newclass.run(start_from_results=False,save_result_data=True,save_structure_analysis=True,restart_from_saved_structure_analysis=False, path_to_save="Results/Results_First_Rule_ICSD.json")
...
newclass.run(start_from_results=False, save_result_data=True,path_to_save='Results/Results_Second_Rule_ICSD.json',save_structure_analysis=True,restart_from_saved_structure_analysis=False)
...
newclass.run(start_from_connections=True, save_connections=True, connections_folder='AnalysisConnections_exp',
             start_from_results=False, save_result_data=True, restart_from_saved_structure_analysis=False,
             save_structure_analysis=True, path_to_save='Results/Results_Third_Rule_ICSD.json',maxCN=8)
...
print("Analyse Pauling rules 2-5 and print percentage of structures fulfilling the rule")
...
newclass.run(remove_elements_low_entropy=False, start_from_connections=True,
            ...
            path_to_save='Results/Results_AllRules_ICSD.json', threshold_remove_elements=0.95, start_material=None,
...
newclass = AllPaulingOverAllAnalysis_Final_Summary(source='experimental', onlybinaries=False, plot_element_dependend_analysis=True,
                                     lowest_number_environments_for_plot=50, lower_limit_plot=0.6, upper_limit_plot=1.0,
                                     analyse_structures=False, use_prematching=True)
...
newclass.run(remove_elements_low_entropy=False, start_from_connections=True, save_connections=True,
             ...
             start_from_results=False, save_result_data=True,
             path_to_save='Results/Results_AllRules_final_plot_ICSD.json', start_material=None, stop_material=None,
